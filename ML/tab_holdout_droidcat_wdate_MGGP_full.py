...
if __name__=="__main__":
    ...
    (bf3, bl3) = loadBenignData('features_droidcat_byfirstseen/zoobenign2010')
    bf1.update(bf3)
    bl1.update(bl3)
    ...
    (mf3, ml3) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/drebin2010','/home/hcai/Downloads/Drebin', pruneMinor=bPrune, drebin=True, obf=False)
    '''
    for app in mf3.keys():
    ...
    (mf4, ml4) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/vs2009','/home/hcai/Downloads/VirusShare/2013', pruneMinor=bPrune, drebin=False, obf=True)
    bf1.update (mf4)
    bl1.update (ml4)

    (mf5, ml5) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/vs2010','/home/hcai/Downloads/VirusShare/2013', pruneMinor=bPrune, drebin=False, obf=True)
    bf1.update (mf5)
    bl1.update (ml5)

    (mf6, ml6) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/vs2011','/home/hcai/Downloads/VirusShare/2013', pruneMinor=bPrune, drebin=False, obf=True)
    bf1.update (mf6)
    bl1.update (ml6)

    (mf7, ml7) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/zoo2010','/home/hcai/Downloads/AndroZoo/2010', pruneMinor=bPrune, drebin=False, obf=True)
    bf1.update (mf7)
    bl1.update (ml7)
    ...
    (mf10, ml10) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/drebin2011','/home/hcai/Downloads/Drebin', pruneMinor=bPrune, drebin=True, obf=False)
    bf1.update (mf10)
    bl1.update (ml10)
