...
if __name__=="__main__":
    ...
    (bf1, bl1) = loadBenignData('features_droidcat_byfirstseen/zoobenign2016')
    ...
    (bf3, bl3) = loadBenignData('features_droidcat_byfirstseen/zoobenign2017')
    bf1.update(bf3)
    bl1.update(bl3)
    ...
    (mf1, ml1) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/zoo2016','/home/hcai/Downloads/AndroZoo/2016', pruneMinor=bPrune, drebin=False, obf=False)
    ...
    (mf2, ml2) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/zoo2017','/home/hcai/Downloads/AndroZoo/2017', pruneMinor=bPrune, drebin=False, obf=True)
    ...
    #(mf3, ml3) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/malware2015','/home/hcai/testbed/cg.instrumented/malware/installed', pruneMinor=bPrune, drebin=False, obf=False)
    (mf3, ml3) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/malware2016','/home/hcai/testbed/newmalwareall', pruneMinor=bPrune, drebin=False, obf=False)
    ...
    roc_bydate(g_binary, models[0], trainfeatures, trainlabels, testfeatures, testlabels, 'droidcat_ZOZO_full')
    sys.exit(0)
