...
if __name__=="__main__":
    ...
    (bf1, bl1) = loadBenignData('features_droidcat_byfirstseen/benign2012')

    #(bf2, bl2) = loadBenignData('features_droidcat_byfirstseen/benign2017')
    (bf2, bl2) = loadBenignData('features_droidcat_byfirstseen/zoobenign2013')
    '''
    for app in bf2.keys():
    ...
    (bf3, bl3) = loadBenignData('features_droidcat_byfirstseen/zoobenign2012')
    bf1.update(bf3)
    bl1.update(bl3)

    (bf4, bl4) = loadBenignData('features_droidcat_byfirstseen/benign2013')
    bf1.update(bf4)
    bl1.update(bl4)
    ...
    (mf2, ml2) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/drebin2012','/home/hcai/Downloads/Drebin', pruneMinor=bPrune, drebin=True, obf=False)
    bf1.update (mf2)
    bl1.update (ml2)

    (mf4, ml4) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/malware2012','/home/hcai/testbed/cg.instrumented/malware/installed', pruneMinor=bPrune, drebin=False, obf=False)
    ...
    (mf5, ml5) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/malware2013','/home/hcai/testbed/cg.instrumented/malware/installed', pruneMinor=bPrune, drebin=False, obf=False)
    bf1.update (mf5)
    bl1.update (ml5)
    ...
    (mf6, ml6) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/vs2012','/home/hcai/Downloads/VirusShare/2013', pruneMinor=bPrune, drebin=False, obf=True)
    bf1.update (mf6)
    bl1.update (ml6)

    (mf7, ml7) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/vs2013','/home/hcai/Downloads/VirusShare/2013', pruneMinor=bPrune, drebin=False, obf=True)
    bf1.update (mf7)
    bl1.update (ml7)

    (mf8, ml8) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/zoo2012','/home/hcai/Downloads/AndroZoo/2012', pruneMinor=bPrune, drebin=False, obf=True)
    bf1.update (mf8)
    bl1.update (ml8)

    (mf9, ml9) = loadMalwareData(g_binary, 'features_droidcat_byfirstseen/zoo2013','/home/hcai/Downloads/AndroZoo/2013', pruneMinor=bPrune, drebin=False, obf=True)
    bf1.update (mf9)
    bl1.update (ml9)
    ...
    roc_bydate(g_binary, models[0], trainfeatures, trainlabels, testfeatures, testlabels, 'droidcat_DRGP_full')
