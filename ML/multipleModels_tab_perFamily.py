    ...
    for j in range(0,k):
        ...
        if g_accuracy:
            ...
            if g_binary:
                ...
                acc=accuracy_score(testLabels, y_pred, average='binary', pos_label="MALICIOUS")
            else:
                prec=precision_score(testLabels, y_pred, average='weighted',labels=("BENIGN",g_label))
                rec=recall_score(testLabels, y_pred, average='weighted',labels=("BENIGN",g_label))
                f1=f1_score(testLabels, y_pred, average='weighted',labels=("BENIGN",g_label))
                '''
