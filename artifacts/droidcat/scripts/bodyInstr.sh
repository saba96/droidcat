...
MAINCP=".:$ROOT/libs/rt.jar:$ROOT/libs/polyglot.jar:$ROOT/libs/sootclasses-trunk.jar:$ROOT/libs/jasminclasses-trunk.jar:$ROOT/workspace/duafdroid/bin:$ROOT/workspace/iac/bin:$ROOT/libs/java_cup.jar"
