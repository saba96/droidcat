...
if (len(packagenames) == 1):
    ...
    #select the items from response.docV2 and print out
    #the whold page info
    print response.docV2.creator
    #description
    #print response.docV2.descriptionHtml
    #app details
    #print response.docV2.details.appDetails
    #print response.docV2.details.appDetails.uploadDate
