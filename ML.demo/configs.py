...
'''
malwareLabelsFile=os.getcwd()+"/malware_labels.txt"

malwareMappingFile=os.getcwd()+"/mapping.malware"

malwareFamilyListFile=os.getcwd()+"/malwareFamilies.txt"

'''
shell script for retrieving package name of a given APK
'''
BIN_GETPACKNAME=os.getcwd()+"/getpackage.sh"
