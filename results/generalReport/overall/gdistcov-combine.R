...
boxplot(s, names=xnames,col=colors,range=0,ylab="percentage (unique view)",cex.axis=0.3,lwd=0.3,cex.lab=0.3)
...
boxplot(d, names=xnames,col=colors,ylab="percentage (unique view)",range=0,cex.axis=0.3,lwd=0.3,cex.lab=0.3)
