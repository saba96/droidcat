...
boxplot(s, names=xnames,col=colors,xlab="code layer",ylab="percentage (unique view)",range=0,cex.axis=0.3,lwd=0.3,cex.lab=0.3)
...
boxplot(d, names=xnames,col=colors,xlab="code layer",ylab="percentage (unique view)",range=0,cex.axis=0.3,lwd=0.3,cex.lab=0.3)
