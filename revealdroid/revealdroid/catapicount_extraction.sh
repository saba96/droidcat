...
MAINCP=bin:$ANDROID_HOME/android-19/android.jar:../soot-infoflow/bin:../soot-infoflow-android/bin:../handleflowdroid/bin:../heros/bin:../soot/classes:../jasmin/classes:../heros/target/classes/
for i in lib/*.jar;
do
    MAINCP=$MAINCP:$i
done
