...
public class Appgraph {
	public static void main(String[] args) {
		...
		try {
			app.calculateSourcesSinksEntrypoints("soot/SourcesAndSinks.txt");
		} catch (IOException e) {
			e.printStackTrace();
		...
		Options.v().set_soot_classpath("soot/soot-trunk.jar:soot/soot-infoflow.jar:soot/soot-infoflow-android.jar:soot/axml-2.0.jar:soot/slf4j-simple-1.7.5.jar:soot/slf4j-api-1.7.5.jar");
